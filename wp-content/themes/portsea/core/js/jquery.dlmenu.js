...
(function ($, window, undefined) {
    ...
    $.DLMenu.prototype = {
        _init: function (options) {
            this.$el.children('ul.dl-menu').find(".dl-submenu").each(function () {
                $(this).prepend('<li class="dl-back"><a href="#">back </a><span>' + $(this).prev().text() + '</span></li>')
                $(this).prev().append("<span class='arrow'>")
            })
        ...
        _config: function () {
            ...
            this.$menuitemsArrow = this.$menu.find('li:not(.dl-back) > a > .arrow');
        ...
        _closeMenu: function () {
            ...
            console.log($(this.$el).closest(".dl-menu-wrap").removeClass("active"))
            console.log($("html").removeClass("dl-menu-opened"))
        ...
        _openMenu: function () {
            ...
            console.log($(this.$el).closest(".dl-menu-wrap").addClass("active"))
            console.log($("html").addClass("dl-menu-opened"))
            this.open = true;
        },
