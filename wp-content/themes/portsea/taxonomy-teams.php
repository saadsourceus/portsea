...
?>
			...
			<li class="<?php if ( 0 == $the_query->current_post || 1 == $the_query->current_post ) {echo 'not-first-two-posts';}else {echo 'not-first-two-posts';}; ?> clearfix">
...
?>
				 ...
				 <div class="profile-thumb" style="background-image: url('<?php echo $thumb; ?>')">
				 	...
				 	<?php if ( get_field( 'player_link' ) ) { ?><a href="<?php echo get_permalink(); ?>" class="profile-link" target="_self"></a><?php } ?>
				 </div>




				<a href="<?php echo get_permalink(); ?>" class="profile-details">
