 ...
 */
$title = ( is_search() ? sprintf( __( 'Your search for %s did not match any entries.', 'responsive' ), get_search_query() ) : __( 'Page Not Found', 'responsive' ) );
?>

	<h1 class="title-404"><?php echo $title; ?></h1>

	<p><?php _e( 'The page you requested was not found.', 'responsive' ); ?></p>
