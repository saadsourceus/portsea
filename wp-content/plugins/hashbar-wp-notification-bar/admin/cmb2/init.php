...
if ( ! class_exists( 'CMB2_Bootstrap_231', false ) ) {
	...
	class CMB2_Bootstrap_231 {
		...
		/**
		 * Single instance of the CMB2_Bootstrap_231 object
		 *
		 * @var CMB2_Bootstrap_231
		 */
		public static $single_instance = null;

		/**
		 * Creates/returns the single instance CMB2_Bootstrap_231 object
		 *
		 * @since  2.0.0
		 * @return CMB2_Bootstrap_231 Single instance object
		 */
